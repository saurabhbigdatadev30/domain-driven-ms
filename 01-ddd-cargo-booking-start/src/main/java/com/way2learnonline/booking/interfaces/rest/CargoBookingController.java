...
public class CargoBookingController {
    ...
    public BookingId bookCargo(@RequestBody  BookCargoResource bookCargoResource){
        ...
        // DTO to command obj... 
        BookCargoCommand bookCargocommandobj = BookCargoCommandDTOAssembler.toCommandFromDTO(bookCargoResource);
        BookingId bookingId  = cargoBookingCommandService.bookCargo(bookCargocommandobj);
        return bookingId;
    }
